...
pub use depthai_viewer::{
    components::{
        ...
        TextEntry, Transform, Vec2D, Vec3D, Vec4D, ViewCoordinates, TensorColormap,
    },
...
#[pyfunction]
fn main(py: Python<'_>, argv: Vec<String>, sys_exe: String, venv_site: Option<String>) -> PyResult<u8> {
