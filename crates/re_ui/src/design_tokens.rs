...
pub struct DesignTokens {
    ...
    pub success_200: egui::Color32,
    pub success_300: egui::Color32,
    pub success_400: egui::Color32,
    pub success_500: egui::Color32,
    pub success_600: egui::Color32,
    pub success_700: egui::Color32,
    ...
    pub gray_100: egui::Color32,
    pub gray_200: egui::Color32,
    pub gray_300: egui::Color32,
    pub gray_400: egui::Color32,
    pub gray_500: egui::Color32,
    pub gray_600: egui::Color32,
    pub gray_700: egui::Color32,
    pub gray_800: egui::Color32,
...
fn apply_design_tokens(ctx: &egui::Context) -> DesignTokens {
    ...
    DesignTokens {
        ...
        success_200: get_global_color(&json, "{Global.Color.Success.200}"),
        success_300: get_global_color(&json, "{Global.Color.Success.300}"),
        success_400: get_global_color(&json, "{Global.Color.Success.400}"),
        success_500: get_global_color(&json, "{Global.Color.Success.500}"),
        success_600: get_global_color(&json, "{Global.Color.Success.600}"),
        success_700: get_global_color(&json, "{Global.Color.Success.700}"),
        ...
        error_bg_color: get_global_color(&json, "{Global.Color.Error.500}"),
        error_hover_bg_color: get_global_color(&json, "{Global.Color.Error.600}"),
        ...
        gray_100: get_global_color(&json, "{Global.Color.Gray.100}"),
        gray_200: get_global_color(&json, "{Global.Color.Gray.200}"),
        gray_300: get_global_color(&json, "{Global.Color.Gray.300}"),
        gray_400: get_global_color(&json, "{Global.Color.Gray.400}"),
        gray_500: get_global_color(&json, "{Global.Color.Gray.500}"),
        gray_600: get_global_color(&json, "{Global.Color.Gray.600}"),
        gray_700: get_global_color(&json, "{Global.Color.Gray.700}"),
        gray_800: get_global_color(&json, "{Global.Color.Gray.800}"),
