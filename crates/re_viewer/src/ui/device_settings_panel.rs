use crate::{ depthai::depthai::{ self, CameraBoardSocket }, misc::ViewerContext };
...
impl DeviceSettingsPanel {
                        ...
                        ui.add_sized(
                            ...
                            |ui: &mut egui::Ui| {
                                ui.horizontal(|ui| {
                                    ...
                                    if
                                        !currently_selected_device.id.is_empty() &&
                                        ...
                                        ui.add_sized(
                                            ...
                                            |ui: &mut egui::Ui| {
                                                ui.scope(|ui| {
                                                    ...
                                                    let hover_color =
                                                        ctx.re_ui.design_tokens.error_hover_bg_color;
    ...
    fn camera_config_ui(
        ...
        egui::CollapsingHeader
            ::new(
                egui::RichText
                    ::new(camera_features.board_socket.display_name(ctx))
                    .color(primary_700)
            )
            .default_open(true)
            .show(ui, |ui| {
                ui.vertical(|ui| {
                            ...
                            for res in camera_features.resolutions.clone() {
                                ...
                                ui.add_enabled_ui(!disabled, |ui| {
                                    ui.selectable_value(
                                        ...
                                        ui.label(
                                            format!("{res} will be available in a future release!")
                                        );
                                    });
                                });
                            }
                    ...
                    ctx.re_ui.labeled_checkbox(ui, "Stream", &mut camera_config.stream_enabled);
                });
            });
    }
    ...
    fn device_configuration_ui(ctx: &mut ViewerContext<'_>, ui: &mut egui::Ui) {
        ...
        ctx.re_ui.styled_scrollbar(ui, re_ui::ScrollAreaDirection::Vertical, [false; 2], |ui| {
            (egui::Frame {
                ...
                ui.horizontal(|ui| {
                    ui.vertical(|ui| {
                        ...
                        ui.collapsing(egui::RichText::new("AI settings").color(primary_700), |ui| {
                            ui.vertical(|ui| {
                                ui.set_width(CONFIG_UI_WIDTH);
                                ctx.re_ui.labeled_combo_box(
                                    ui,
                        ...
                        ui.add_enabled_ui(
                            ...
                            |ui| {
                                egui::CollapsingHeader
                                    ::new(egui::RichText::new("Depth Settings").color(primary_700))
                                    .open(
                            ...
                            ui.horizontal(|ui| {
                                ...
                                ui.add_enabled_ui(apply_enabled, |ui| {
                                    ui.scope(|ui| {
                                        let mut style = ui.style_mut().clone();
                                        if apply_enabled {
                                            let color = ctx.re_ui.design_tokens.primary_bg_color;
                                            let hover_color =
